...
from decoder_iq.graph_creator_IQ import GraphCreator
...
class GRUDecoder(nn.Module):
    ...
    def __init__(self, args: Args):
        ...
        self.dropout_gnn = nn.Dropout(p=0.2) # Dropout-layer för GNN embeddings, is this value optimal?
        ...
        self.rnn = nn.GRU(
            ...
            dropout=0.3, # Is this value optimal?
            batch_first=True
        )
        ...
        with torch.no_grad():
            for batch in tqdm(test_batches, desc="Evaluating model on test batches"):
                ...
                if self.args.train_all_times:
                    ...
                    loss = nn.functional.binary_cross_entropy(final_pred, last_label_soft)
